...
const API_URL_EmbezzlementCategory = `${environment.apiUrl}/EmbezzlementCategory`;
...
export class EmbezzlementCategoryService {
  ...
  getEmbezzlementCategories(): Observable<Array<EmbezzlementCategoryModel>> {
    return this.http.get(`${API_URL_EmbezzlementCategory}/GetEmbezzlementCategories`, {
  ...
  createEmbezzlementCategory(createModel: EmbezzlementCategoryCreateModel) {
    return this.http.post(`${API_URL_EmbezzlementCategory}/CreateEmbezzlementCategory`, createModel, {
      headers: this.httpHeaders
    }).pipe(map((res: BaseResponse<number>) => res))
  }

  updateEmbezzlementCategory(updateModel: EmbezzlementCategoryUpdateModel) {
    return this.http.put(`${API_URL_EmbezzlementCategory}/UpdateEmbezzlementCategory`, updateModel, {
      headers: this.httpHeaders
    }).pipe(map((res: BaseResponse<number>) => res))
  }

  deleteEmbezzlementCategory(id: number) {
    return this.http.delete(`${API_URL_EmbezzlementCategory}/DeleteEmbezzlementCategory?id=${id}`, {
      headers: this.httpHeaders,
    }).pipe(map((res: BaseResponse<boolean>) => res))
  }

  getEmbezzlementCategoryById(id: number) {
    return this.http.get(`${API_URL_EmbezzlementCategory}/GetEmbezzlementCategoryById?id=${id}`, {
      headers: this.httpHeaders,
